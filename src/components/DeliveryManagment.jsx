          ...
          <form onSubmit={handleAddRoute} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <input
                ...
                className={`w-full border-2 rounded-lg sm:rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 focus:ring-2 focus:ring-[#de5422] focus:border-transparent outline-none transition-all duration-300 text-sm sm:text-base ${
                  addingRoute 
            ...
            <div className="sm:col-span-2 lg:col-span-1 flex items-end">
              <button 
                type="submit"
                disabled={addingRoute}
                className={`w-full font-semibold px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg sm:rounded-xl shadow-lg transition-all duration-300 transform text-sm sm:text-base ${
                  addingRoute 
              ...
              >
                ...
                <div className="px-4 sm:px-6 pb-4 sm:pb-6 flex items-center justify-end gap-3">
                  <button
                    ...
                    disabled={deleting}
                    className={`px-3 sm:px-4 py-2 rounded-lg font-semibold border transition text-sm sm:text-base ${
                      deleting ? "cursor-not-allowed opacity-70" : "hover:bg-gray-50"
                    }`}
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    disabled={deleting}
                    className={`px-3 sm:px-4 py-2 rounded-lg font-semibold text-white transition shadow text-sm sm:text-base ${
                      deleting
                        ? "bg-gray-400 cursor-not-allowed"
